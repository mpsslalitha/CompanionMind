...
st.set_page_config(
    page_title="CompanionMind",  # Title of the page
...
def app_pages():
    ...
    with tabs[0]:
        ...
        re_image = image.resize((1400,650))
        st.image(re_image)
        with st.container():
            st.markdown(
                """
